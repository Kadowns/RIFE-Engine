...
namespace Rife::Graphics {
    VkCommandBuffer VulkanData::beginSingleTimeCommands() {
    ...
    void VulkanData::endSingleTimeCommands(VkCommandBuffer commandBuffer) {
    ...
    void VulkanData::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout) {
    ...
    void VulkanData::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height) {
    ...
    bool VulkanData::hasStencilComponent(VkFormat format) {
